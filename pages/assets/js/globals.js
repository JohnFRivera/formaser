...
cssStyle.href = `${Hosting}/pages/assets/css/styles.css`;
document.head.appendChild(cssStyle);
var cssDataTable = document.createElement("link");
cssDataTable.rel = "stylesheet";
cssDataTable.href = `${Hosting}/pages/admin/assets/css/dataTables.min.css`;
document.head.appendChild(cssDataTable);
//header
document.querySelector("header").innerHTML = `
<div class="row py-2 px-5">
    <!-- LOGO -->
    <div class="col-auto">
        <img class="img-fluid me-0 me-md-5" src="${Hosting}/pages/assets/pic/sena-logo.png" alt="sena_logo">
    </div>
    <!--* LINKS -->
