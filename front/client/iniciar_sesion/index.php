...
<body>
    ...
    <main class="container-fluid">
        <div class="row justify-content-center bg-img-formaser">
            <div class="col col-sm-6 col-md-5 col-lg-4 align-content-center">
                <!--* INICIO DE SESIÓN -->
                    ...
                    <form action="">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="form-control border-dark-subtle p-0">
                                <div class="form-floating">
                                    <input type="email" class="form-control border-0 rounded-start-0" id="floatingInput"
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-control border-dark-subtle p-0 border-end-0">
                                <div class="form-floating">
                                    <input type="password" class="form-control border-0 rounded-start-0 rounded-end-0" id="password"
                        ...
                        <div class="mt-2 mt-sm-0 d-flex justify-content-end">
                            <input class="btn btn-verde px-4" type="submit" value="Ingresar">
                        </div>
                    </form>
                </div>
            </div>
