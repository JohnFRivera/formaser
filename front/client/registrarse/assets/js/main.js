...
function ShowPass() {
    var btnShowPass = document.getElementById('showPass');
...
function ConfirmPass() {
    var lblError = document.getElementById('lblConfirmErr');
    if (txtConfirmPass.value.length > 0) {
        if (txtConfirmPass.value == document.getElementById('txtPassword').value) {
...
document.getElementById('txtPassword').addEventListener('focusout', ConfirmPass);
txtConfirmPass.addEventListener('focusout', ConfirmPass);
