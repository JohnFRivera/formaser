                    ...
                    <div class="col">
                        <form action="">
                            <div class="row mb-3">
                                ...
                                <div class="col-auto">
                                    <input type="button" class="btn btn-verde" id="btnSubirPreinscritos" value="Subir" disabled>
                                </div>
                            </div>
                        </form>
                        <div class="row gap-3">
                            <div class="col">
                                ...
                                <div class="table-responsive pb-5">
                                    <table id="dataTableAgregados" class="table table-hover table-striped" style="width:100%">
                                        ...
                                        <tbody id="tblPreinscritosAgregados">
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="table-responsive pb-5">
                                    <table id="dataTableNoAgregados" class="table table-hover table-striped" style="width:100%">
                                        ...
                                        <tbody id="tblPreinscritosNoAgregados">
                                        </tbody>
                                    </table>
                                </div>
                            </div>
