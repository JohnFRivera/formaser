        ...
        <div class="row">
            ...
            <section class="col h-main">
                <div class="row p-3 p-md-4">
                    ...
                    <hr>
                    <!--* OPCIONES -->
                    <ul class="nav nav-underline mb-4 pe-0">
                        <li class="nav-item">
                        ...
                        <form action="">
                            <div class="row mb-3">
                                ...
                                <div class="col-auto px-0">
                                    <label for="archivo-inscrito" class="btn btn-outline-azul fw-semibold px-4">
                                ...
                                <div class="col-auto">
                                    <input type="submit" class="btn btn-verde" value="Subir">
                                </div>
                            </div>
                        </form>
                        <div class="table-responsive">
                            <table id="tblInscrito" class="table table-hover table-striped" style="width:100%">
                                <thead class="fs-5">
                                    <tr>
                                        <th>Nombre</th>
                                        <th>Fecha</th>
