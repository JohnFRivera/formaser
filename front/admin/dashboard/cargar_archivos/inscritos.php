...
<body>
                        ...
                        <form action="">
                            <div class="row mb-3">
                                ...
                                <div class="col col-sm-6 col-md-5 col-lg-4 col-xl-3 ms-auto px-0 d-flex flex-column justify-content-start">
                                    <label for="inpArchivoInscritos" class="btn btn-azul fw-semibold px-4">
                                        <input type="file" class="visually-hidden" name="archivo-inscrito" id="inpArchivoInscritos" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" required>
    ...
    <script src="./assets/js/inscritos.js"></script>
</body>
